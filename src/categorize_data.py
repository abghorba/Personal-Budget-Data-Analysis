...
def perform_data_compilation(
    years=None, months=None, use_threading=False, use_multiprocessing=False, filepath=SPENDING_DATA_TXT_FILEPATH
):
    """
    ...
    save_spending_data_as_text_file(budget_dict, filepath)
